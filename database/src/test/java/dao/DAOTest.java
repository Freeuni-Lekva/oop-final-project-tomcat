...
public class DAOTest {
    ...
    public void testQuizGame() {
        ...
        // test create and read
        Serializable quizGameId = dao.create(new QuizGame(quiz, user, 20, 20, System.currentTimeMillis() - 20000, System.currentTimeMillis(), Bool.FALSE.name()));
        ...
        // test getAll
        dao.create(new QuizGame(quiz, user, 30, 30, System.currentTimeMillis() - 30000, System.currentTimeMillis(), Bool.FALSE.name()));
        dao.create(new QuizGame(quiz, user, 40, 40, System.currentTimeMillis() - 30000, System.currentTimeMillis(), Bool.FALSE.name()));
        dao.create(new QuizGame(quiz, user, 50, 50, System.currentTimeMillis() - 30000, System.currentTimeMillis(), Bool.FALSE.name()));
